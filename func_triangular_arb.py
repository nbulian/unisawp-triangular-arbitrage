                    ...
                    for pair_c in pairs_list:
                        ...
                        if c_pair != a_pair and c_pair != b_pair:
                            ...
                            if counts_c_base == 2 and counts_c_quote == 2 and c_base != c_quote:
                                combine = a_pair + "," + b_pair + "," + c_pair
                                unique_string = ''.join(sorted(combine))
...
def calc_triangular_arb_surface_rate(t_pair, min_rate, starting_amount):
    ...
    for direction in direction_list:
        ...
        # Set variables
        # starting_amount = starting_amount # borrar esta linea
        acquired_coin_t2 = 0
        acquired_coin_t3 = 0
        calculated = 0
        ...
        # Forward: check if aQuote (acquired coin) matches cQoute
        if direction == "forward":
